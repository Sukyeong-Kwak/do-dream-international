...
export default function ProgramHero() {
  ...
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-brand-primary-blue">
      {/* Background image */}
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1523580494863-6f3031224c94?auto=format&fit=crop&q=80&w=1974"
      ...
      <div className="relative z-10 container-custom text-center px-6">
        ...
        <motion.h1
          ...
          className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tighter max-w-4xl mx-auto mb-6"
        >
          {t('hero.title')}
        </motion.h1>
